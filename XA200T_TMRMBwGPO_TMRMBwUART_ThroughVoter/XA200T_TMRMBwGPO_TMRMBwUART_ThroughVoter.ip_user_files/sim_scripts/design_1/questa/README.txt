...
#
# Generated by export_simulation on Sun Nov 22 19:24:53 +0100 2015
#
################################################################################
...
switch to the './design_1.bat' script.

./design_1.bat -reset_run
...
./design_1.bat -noclean_files

For more information on the script, please type './design_1.bat -help'.
...
Name   : filelist.f
Purpose: This file contains a flat list of design files based on the compile
         order when export_simulation was executed. By default, the source file
         paths are set relative to the current directory. If -absolute_path
         switch was specified with export_simulation, then the file paths will
         be set absolute.
