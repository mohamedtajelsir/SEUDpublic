...
#
# Generated by export_simulation on Tue Dec 15 06:53:20 +0100 2015
#
################################################################################
...
switch to the './clk_wiz.sh' script.

./clk_wiz.sh -reset_run
...
./clk_wiz.sh -noclean_files

For more information on the script, please type './clk_wiz.sh -help'.
