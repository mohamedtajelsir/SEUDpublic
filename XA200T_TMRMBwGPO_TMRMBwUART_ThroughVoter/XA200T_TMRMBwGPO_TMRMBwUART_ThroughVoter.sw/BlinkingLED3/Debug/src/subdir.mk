...
src/%.o: ../src/%.c
	...
	mb-gcc -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -I../../UARTPrint3_bsp/microblaze_3/include -mlittle-endian -mcpu=v9.5 -mxl-soft-mul -Wl,--no-relax -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
