...
proc update_PARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON { PARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON } {
	# Procedure called to update NUMBER_OF_REGISTERS_TO_BE_VOTED_ON when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON { PARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON } {
	# Procedure called to validate NUMBER_OF_REGISTERS_TO_BE_VOTED_ON
	return true
}
...
proc update_MODELPARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON { MODELPARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON PARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON}] ${MODELPARAM_VALUE.NUMBER_OF_REGISTERS_TO_BE_VOTED_ON}
}
